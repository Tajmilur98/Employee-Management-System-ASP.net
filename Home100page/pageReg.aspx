<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageReg.aspx.cs" Inherits="Home100page.pageReg" %>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style4">
                    <asp:TextBox ID="TextBoxId" runat="server" Width="180px" placeholder="Enter User Id" CssClass="auto-style6"></asp:TextBox>
                </td>
                <td class="auto-style5">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBoxUN" CssClass="auto-style6" ErrorMessage="User Name is required"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style7">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:Button ID="Button1" runat="server" Text="Submit"  Visible="true" BackColor="#330000" style="color: #FFFFFF; margin-left: 37px; font-weight: 700;" Width="103px" Height="25px" OnClick="Button1_Click"/>
                   </td>
                <td>
                    &nbsp;</td>
            </tr>
