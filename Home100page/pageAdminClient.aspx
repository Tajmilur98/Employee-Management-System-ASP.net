<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageAdminClient.aspx.cs" Inherits="Home100page.pageAdminClient" %>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link " href="#page-top">Manage Clients</a></li>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                        ...
                        <div class="auto-style1 justify-content-center">
                            <h2 class="float-lg-center text-bold text-white" style="width:530px"><u>MANAGE CLIENT AND ORDERS</u></h2>
                            <table style="width:530px">
                                <tr>
                                    <td style="text-align: Left" class="text-white">Phone Number </td>
                                    <td>
                                        <asp:TextBox ID="cid" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="text-align: Left" class="text-white">Name </td>
                                    <td>
                                        <asp:TextBox ID="name" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="text-align: Left" class="text-white">Project Id</td>
                                    <td>
                                        <asp:TextBox ID="pid" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="text-align: Left" class="text-white">Project Title</td>
                                    <td>
                                        <asp:TextBox ID="ptitle" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>
                                
                                <tr>
                                    <td style="text-align: Left" class="text-white">Deal Amount</td>
                                    <td>
                                        <asp:TextBox ID="damount" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>

                                <tr>
                                    <td style="text-align: Left" class="text-white">Received Amount</td>
                                    <td>
                                        <asp:TextBox ID="ramount" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="text-align: Left" class="text-white">Enter Phone for Reject / Update</td>
                                    <td>
                                        <asp:TextBox ID="idd" CssClass="txtbx" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td colspan="10" align="center" class="auto-style3">
                                        <asp:Button class="btn" ID="Button1" runat="server" Text="Grant" OnClick="Button1_Click"  BackColor="#458a64" ForeColor="White"  />
                                        <asp:Button class="btn" ID="Button2" runat="server" Text="Reject" OnClick="Button2_Click"  BackColor="#e36052" ForeColor="White" />
                                        <asp:Button class="btn" ID="Button3" runat="server" Text="Update" OnClick="Button3_Click"  BackColor="#d1ad5e" ForeColor="White" />
